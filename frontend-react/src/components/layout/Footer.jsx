...
export default function Footer() {
    return (
        <footer className="border-t border-gray-200 dark:border-white/10 mt-32 py-10 relative overflow-hidden">
                ...
                <div className="flex items-center gap-6">
                    {LINKS.map(lk => lk.external ? (
                        <a key={lk.label} href={lk.href} target="_blank" rel="noreferrer"
                            className="text-sm text-gray-500 dark:text-gray-500 hover:text-gray-900 dark:text-white transition-colors">
                            {lk.label}
                        </a>
                    ) : (
