            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                ...
                <div className="flex items-center justify-center gap-2 mb-10">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-violet-600 to-cyan-600 flex items-center justify-center">
                        <AreaChart className="w-5 h-5 text-gray-900 dark:text-white" />
                    </div>
                    <span className="text-lg font-black text-gray-900 dark:text-white">PixelTrade</span>
                </div>

                <h1 className="text-2xl font-black text-gray-900 dark:text-white mb-1 text-center">Welcome back</h1>
                <p className="text-gray-500 dark:text-gray-500 text-sm mb-8 text-center">Sign in to your account</p>

                <div className="bg-white dark:bg-[#0d1117] border border-gray-200 dark:border-white/10 rounded-2xl p-7">
